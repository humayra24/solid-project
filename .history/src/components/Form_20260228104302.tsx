...
export default function Form(){
    ...
    return(
        <main>
            ...
            <input type="checkbox" checked={formData().agree} onChange={(e) => updateField("agree", e.currentTarget.checked)} />
            <label>I agree to the terms and conditions</label>
            
            <input type="button" value="Submit" onClick={() => console.log(formData())} />
        </main>
    )
}